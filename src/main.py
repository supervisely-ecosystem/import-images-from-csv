...
from ui.import_settings import process_images_from_csv, process_images_from_csv_by_link
...
def process(api: sly.Api, task_id, context, state, app_logger):
    if state["addMode"] == "copyData":
        ...
        process_images_from_csv_by_link(api, state, g.image_col_name, g.tag_col_name, app_logger)
